...
contract ERC721OnlyOwnerTransferable is IERC721, IERC721Metadata, Ownable {
     ...
     *
     * Tokens can be managed by the contract owner.
     *
     ...
     * Emits a {Transfer} event.
     */
    function _burn(uint256 tokenId) internal onlyOwner {
